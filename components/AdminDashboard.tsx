...
type AdminTab = 'header' | 'about' | 'portfolio';
...
const AdminDashboard: React.FC<AdminDashboardProps> = ({ theme, toggleTheme, supabase, initialContent, onSaveSuccess }) => {
  ...
  const handleInputChange = (section: 'header' | 'about', field: string, value: string) => {
  ...
  const handleSave = async () => {
    ...
    try {
        ...
        // ETAPA B: Salvar (upsert) as seções 'header' e 'about'.
